...
legend("topright",c("Sub_metering_1","Sub_metering_2","Sub_metering_3"),lty=1,col=c("black","orangered","blue"),cex=.75,bty="o")
dev.copy(png,filename="ToGit/ExData_Plotting1/plot3.png",width=480,height=480)
dev.off();